                            ...
                            <div class="p-5">
                                ...
                                <form action="<?= route_to('register') ?>" method="post" class="user">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" name="pass_confirm" class="form-control form-control-user <?php if (session('errors.pass_confirm')) : ?>is-invalid<?php endif ?>" placeholder="Repeat Password" autocomplete="off">
                                        </div>
                                    </div>
                                ...
                                <div class="text-center">
                                    <p><a class="small" href="<?= route_to('login') ?>">Already have an account? Login!</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
